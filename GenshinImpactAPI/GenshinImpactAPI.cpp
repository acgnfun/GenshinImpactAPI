...
#define CIURL_CONTENT_OFFICIAL	"https://hk4e-launcher-static.mihoyo.com/hk4e_cn/mdk/launcher/api/content?filter_adv=true&key=eYd89JmJ&language=zh-cn&launcher_id=18"
#define CIURL_CONTENT_BILIBILI	"https://hk4e-launcher-static.mihoyo.com/hk4e_cn/mdk/launcher/api/content?filter_adv=true&key=KAtdSsoQ&language=zh-cn&launcher_id=17"
#define CIURL_CONTENT_GLOBAL	"https://hk4e-launcher-static.hoyoverse.com/hk4e_global/mdk/launcher/api/content?filter_adv=true&key=gcStgarh&language=zh-cn&launcher_id=10"
...
#define CIURL_CONTENTW_OFFICIAL	L"https://hk4e-launcher-static.mihoyo.com/hk4e_cn/mdk/launcher/api/content?filter_adv=true&key=eYd89JmJ&language=zh-cn&launcher_id=18"
#define CIURL_CONTENTW_BILIBILI	L"https://hk4e-launcher-static.mihoyo.com/hk4e_cn/mdk/launcher/api/content?filter_adv=true&key=KAtdSsoQ&language=zh-cn&launcher_id=17"
#define CIURL_CONTENTW_GLOBAL	L"https://hk4e-launcher-static.hoyoverse.com/hk4e_global/mdk/launcher/api/content?filter_adv=true&key=gcStgarh&language=zh-cn&launcher_id=10"
// Do not change!!!
...
GIAPI::ErrorCode GIAPI::Manager::ContentIndexUrl(Server ServerId, string& ReturnUrl) const
{
	switch (ServerId)
	{
	case GIAPI::CNREL_OFFICIAL:
		ReturnUrl = CIURL_CONTENT_OFFICIAL;
		break;
	case GIAPI::CNREL_BILIBILI:
		ReturnUrl = CIURL_CONTENT_BILIBILI;
		break;
	case GIAPI::OSREL_GLOBAL:
		ReturnUrl = CIURL_CONTENT_GLOBAL;
		break;
	default:
		ReturnUrl.clear();
		return ServerIdNotSet;
