...
#define RIURL_CNREL_0	"https://sdk-static.mihoyo.com/hk4e_cn/mdk/launcher/api/resource?key=eYd89JmJ&launcher_id=18&"
#define RIURL_CNREL_1	"https://sdk-static.mihoyo.com/hk4e_cn/mdk/launcher/api/resource?key=KAtdSsoQ&launcher_id=17&channel_id=14&"
#define RIURL_OSREL		"https://hk4e-launcher-static.hoyoverse.com/hk4e_global/mdk/launcher/api/resource?key=gcStgarh&launcher_id=10&sub_channel_id=3&"
#define RIURL_CNRELW_0	L"https://sdk-static.mihoyo.com/hk4e_cn/mdk/launcher/api/resource?key=eYd89JmJ&launcher_id=18&"
#define RIURL_CNRELW_1	L"https://sdk-static.mihoyo.com/hk4e_cn/mdk/launcher/api/resource?key=KAtdSsoQ&launcher_id=17&channel_id=14&"
#define RIURL_OSRELW	L"https://hk4e-launcher-static.hoyoverse.com/hk4e_global/mdk/launcher/api/resource?key=gcStgarh&launcher_id=10&sub_channel_id=3&"
// Do not change!!!

#define SHORTCUT_NAME_NO_SUFFIX			"Ô­Éñ"
...
GIAPI::ErrorCode GIAPI::Manager::GetInstallPackageUrl(int Language, strlist& ReturnList) const
{
	...
	try
	{
		for (size_t i = 0; i < ResourceIndex["data"]["game"]["latest"]["segments"].size(); i++)
			ReturnList.push_back(std::string(ResourceIndex["data"]["game"]["latest"]["segments"][i]["path"]));
		for (size_t i = 0; i < ResourceIndex["data"]["game"]["latest"]["voice_packs"].size(); i++)
			if ((Language & zh_CN) && ResourceIndex["data"]["game"]["latest"]["voice_packs"][i]["language"] == "zh-cn")
				ReturnList.push_back(std::string(ResourceIndex["data"]["game"]["latest"]["voice_packs"][i]["path"]));
...
GIAPI::ErrorCode GIAPI::Manager::GetPreInstallPackageUrl(int Language, strlist& ReturnList) const
{
	...
	try
	{
		for (size_t i = 0; i < ResourceIndex["data"]["pre_download_game"]["latest"]["segments"].size(); i++)
			ReturnList.push_back(std::string(ResourceIndex["data"]["pre_download_game"]["latest"]["segments"][i]["path"]));
		for (size_t i = 0; i < ResourceIndex["data"]["pre_download_game"]["latest"]["voice_packs"].size(); i++)
			if ((Language & zh_CN) && ResourceIndex["data"]["pre_download_game"]["latest"]["voice_packs"][i]["language"] == "zh-cn")
				ReturnList.push_back(std::string(ResourceIndex["data"]["pre_download_game"]["latest"]["voice_packs"][i]["path"]));
...
GIAPI::ErrorCode GIAPI::Manager::GetUpdatePackageUrl(strlist& ReturnList) const
{
	...
	try
	{
		ReturnList.push_back(std::string(Diff["path"]));
		for (size_t i = 0; i < Diff["voice_packs"].size(); i++)
			if ((Language & zh_CN) && Diff["voice_packs"][i]["language"] == "zh-cn")
				ReturnList.push_back(std::string(Diff["voice_packs"][i]["path"]));
...
GIAPI::ErrorCode GIAPI::Manager::GetPreUpdatePackageUrl(strlist& ReturnList) const
{
	if (!ResourceIndexStat) return ResourceIndexNotLoaded;
	if (!StatPreDownload()) return PredownloadNotSupported;
	if (!StatInstalled()) return NotInstalled;
